...
def main() -> int:
    parser = argparse.ArgumentParser(description="Issue-8 ROI attribute smoke test")
    ...
    parser.add_argument("--with-breed-head", action="store_true")
    parser.add_argument("--lambda-attr-grid", type=float, default=0.0)
    ...
    annotations_batch: List[List[Dict[str, Any]]] = []
